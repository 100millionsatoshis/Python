...
print('You are a ' + str(main_character_age) + ' years old ' + main_character_race + ' ' + main_character_gender.lower())
...
print("You have " + str(main_character_wealth) + " " + wealth_currency.upper() + " in your bank account.")
print("You wrote currency with capital letters.")
print(wealth_currency.isupper())
print(main_character_body_type.lower().islower())
print("You live with " + str(secondary_character_age) + " years old woman")
